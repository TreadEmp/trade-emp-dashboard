...
import Jobs from "../../../containers/admin/jobs";
    ...
    const fetchData = async () => {
      try {
        const res = await Axios.baseInstance({
          ...
          url: `/jobs/admin?page=${currentPage}&pageSize=10&title=${filters.title}&status=${filters.status}&category=${filters.category}&longitude=${filters.longitude}&latitude=${filters.latitude}&radius=${filters.radius}&employerId=${filters.employerId}&days=${filters.days}`,
          method: "GET",
        });
